      ...
      <div className="px-8 py-10">
        ...
        <div className="text-gray-400 mt-8 flex flex-col">
          ...
          <div className="font-bold inline space-2 text-lg text-black dark:text-white">
            {integerPart}
            <span className="text-sm font-light text-gray-700 dark:text-gray-300">.{decimalPart}</span>
            <span className="text-sm ml-1 font-light text-gray-700 dark:text-gray-300">{account.currency}</span>
          </div>
        </div>
      </div>
